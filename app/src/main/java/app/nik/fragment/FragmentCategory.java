...
import app.nik.ActivityMain;
import app.nik.ActivityPlaceDetail;
import app.nik.R;
import app.nik.adapter.AdapterPlaceGrid;
import app.nik.connection.RestAdapter;
import app.nik.connection.callbacks.CallbackListPlace;
import app.nik.data.AppConfig;
import app.nik.data.Constant;
import app.nik.data.DatabaseHandler;
import app.nik.data.SharedPref;
import app.nik.data.ThisApplication;
import app.nik.model.Place;
import app.nik.utils.Tools;
import app.nik.widget.SpacingItemDecoration;
