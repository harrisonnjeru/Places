...
public class Constant {
    ...
    public static String WEB_URL = "http://places.geeksrepubliq.com/";

    // for map zoom
    public static final double city_lat = 1.2921;
    public static final double city_lng = 36.8219;

    // for gcm
    public static final String PROJECT_API_NUMBER = "489679952842";
