...
public class SharedPref {
    ...
    private static final String GCM_PREF_KEY = "app.nik.data.GCM_PREF_KEY";
    private static final String SERVER_FLAG_KEY = "app.nik.data.SERVER_FLAG_KEY";
    private static final String THEME_COLOR_KEY = "app.nik.data.THEME_COLOR_KEY";
    private static final String LAST_PLACE_PAGE = "LAST_PLACE_PAGE_KEY";

    // need refresh
    public static final String REFRESH_PLACES = "app.nik.data.REFRESH_PLACES";
