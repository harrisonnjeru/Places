...
import app.nik.adapter.AdapterNewsInfo;
import app.nik.connection.API;
import app.nik.connection.RestAdapter;
import app.nik.connection.callbacks.CallbackListNewsInfo;
import app.nik.data.Constant;
import app.nik.data.DatabaseHandler;
import app.nik.model.NewsInfo;
